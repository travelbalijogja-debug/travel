...
// Using inline SVG instead of lucide-react to avoid dependency issues
    ...
    <div className={styles.adminContainer}>
      ...
      <aside className={`${styles.sidebar} ${isSidebarOpen ? styles.sidebarOpen : ''}`}>
        <div className={styles.brand}>
          ...
          <span className={styles.brandText}>NORTH TOUR</span>
        </div>
        ...
        <div className={styles.bottomNav}>
          <Link href="/admin/login" className={styles.navItemLogout}>
            <LogOutIcon />
            <span>Sign Out</span>
          </Link>
        </div>
